...
console.group('Užduotys');
{
    ...
    const letter1 = ['Lietuviškas', 'Nepriklausomas', 'Kanalas'];
    const letter2 = ['Lietuvos', 'Respublikos', 'Televizija'];
    const letter3 = ['Loughing', 'Out', 'Loud'];
    const firstLetters = (strings) => {
        const firstLetter = (full, word) => full + word.charAt(0);
    ...
    const number1 = [1, 7, 8];
    const number2 = [98, 74, 5, 0];
    const number3 = [17, 10, 5];
    function multiplication(arr) {
        const multiplyReducer = (total, num) => (total * num);
