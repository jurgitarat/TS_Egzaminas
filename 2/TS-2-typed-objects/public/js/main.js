...
{
    const isAdult = (testPerson) => { return testPerson.age >= 18; };
    console.log({
...
{
    const isFullyDescribedPerson = (testPerson) => { return testPerson.height != undefined && testPerson.weight != undefined; };
    console.log({
...
{
    const createInitials = (testPerson) => { return testPerson.name.charAt(0) + testPerson.surname.charAt(0); };
    console.log({
